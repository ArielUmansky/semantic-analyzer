...
This route clusters data that should be specified in the body of the request. Also the client can configure other data, like the algorithm used by the analyzer and the metadata of the corpus.
...
The body admits the following parameters:
    ...
    { 
        corpus: [ {document: "Here goes the text of the document. 
