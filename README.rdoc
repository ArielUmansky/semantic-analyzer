...
The body admits the following parameters:
    ...
    { 
        corpus: [ {document: "Here goes the text of the document. All the documents must have it", 
                   category: "optional_category_string", 
                   keywords: ["optional", "array", "of", "keywords", "that", "are", "important", "for", "this",                                  "document"], ... ], 
...
The number of centroids cannot be greater than 
