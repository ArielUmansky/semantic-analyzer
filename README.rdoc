...
The body admits the following parameters:
    ...
    {   
     ...
     corpus: [ {
                ...
                user_info: ... *// This will be by-passed and be returned in the response. *
                          *We recomend to use it to refer each document later*
                }, 
              ... ],

    }
    
This is the structure of the body in the response:
